 ...
 * Überprüft alle erforderlichen Umgebungsvariablen und Integrationen
 */
export const GET: APIRoute = async ({ locals }) => {
  try {
    // Hole alle Umgebungsvariablen
    const env = locals?.runtime?.env || import.meta.env;

    // Definiere alle zu prüfenden Variablen
    const checks = {
      adminPassword: {
        name: 'Admin-Passwort',
        key: 'ADMIN_PASSWORD',
    ...
    // Prüfe Google Calendar Verbindung wenn alle Variablen gesetzt sind
