...
import { v as validateFormData, a as sendAdminNotification, s as sendCustomerNotification } from '../../chunks/email_CLsyDTz6.mjs';
import { K as KV_KEYS, D as DEFAULT_SETTINGS } from '../../chunks/constants_B1Zb3kqG.mjs';
import { a as getLongLabel, c as getEventDate } from '../../chunks/event-config_CKxe_VBp.mjs';
...
const EVENT_DATES = {
  friday: getEventDate("friday"),
  saturday: getEventDate("saturday"),
  sunday: getEventDate("sunday")
};
    ...
    if (autoConfirm && googleClientId && googleClientSecret && googleRefreshToken) {
      try {
        ...
        if (tokenResponse.ok) {
          ...
          const calendarId = locals?.runtime?.env?.GOOGLE_CALENDAR_ID || "fynn.klinkow@mor\no-gmbh.de";
          const description = `
Termin-Details:
