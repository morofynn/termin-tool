...
async function sendEmail(options, env) {
  const googleClientId = env?.GOOGLE_CLIENT_ID || "1016862075130-uc8r6pv6pivrjr4a9ei88gp6puss9htg.apps.googleusercontent.com";
  const googleClientSecret = env?.GOOGLE_CLIENT_SECRET || "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";
  const googleRefreshToken = env?.GOOGLE_REFRESH_TOKEN || "1//04Ck84hmIis09CgYIARAAGAQSNwF-L9IrVeFqvKINk6q5UDZiNWKre6-6EK775cifbJvqLEoys19YAMGoGSCAZZhxOuCZv4gfpb4";
