...
const GET = async ({ request, url }) => {
  ...
  try {
    const clientId = "1016862075130-uc8r6pv6pivrjr4a9ei88gp6puss9htg.apps.googleusercontent.com";
    const clientSecret = "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";
...
<body>
  ...
  <script>
    ...
    console.error("Google OAuth Callback Error:", error2);
    return new Response(
      JSON.stringify({
        success: false,
