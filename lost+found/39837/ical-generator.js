...
var b = ((u) => (u.DAILY = "DAILY", u.HOURLY = "HOURLY", u.MINUTELY = "MINUTELY", u.MONTHLY = "MONTHLY", u.SECONDLY = "SECONDLY", u.WEEKLY = "WEEKLY", u.YEARLY = "YEARLY", u))(b || {});
var A = ((u) => (u.FR = "FR", u.MO = "MO", u.SA = "SA", u.SU = "SU", u.TH = "TH", u.TU = "TU", u.WE = "WE", u))(A || {});
function l(a2, t, e) {
  ...
  else if (typeof t == "object") a2.x = Object.entries(t).map(([n, i]) => {
...
function h(a2, t) {
  ...
  if (a2 instanceof Date || typeof a2 == "string" || S(a2) && a2.isValid === true || (R(a2) || G(a2)) && a2.isValid()) return a2;
...
function p(a2, t) {
  ...
  if (typeof t == "string") {
    let n = t.match(/^(.+) ?<([^>]+)>$/);
    n ? e = { email: n[2].trim(), name: n[1].trim() } : t.includes("@") && (e = { email: t.trim(), name: t.trim() });
  } else typeof t == "object" && (e = { email: t.email, mailto: t.mailto, name: t.name, sentBy: t.sentBy });
  ...
  if (!e.email) throw new Error("`" + a2 + ".email` is empty!");
  return e;
}
function r(a2, t) {
...
`).map(function(t) {
    ...
    for (let i = 0; i < t.length; i++) {
      let s = t.charAt(i);
      s >= "\uD800" && s <= "\uDBFF" && (s += t.charAt(++i));
      let F = new TextEncoder().encode(s).length;
      n += F, n > 74 && (e += `\r
 `, n = F), e += s;
    }
    return e;
...
function d(a2, t, e, n) {
  if ((a2 == null ? void 0 : a2.startsWith("/")) && (a2 = a2.substr(1)), typeof t == "string" || t instanceof Date) {
    let i = H(t) ? t.withTimeZone(a2) : new Date(t), s = i.getUTCFullYear() + String(i.getUTCMonth() + 1).padStart(2, "0") + i.getUTCDate().toString().padStart(2, "0");
    return a2 && (s = i.getFullYear() + String(i.getMonth() + 1).padStart(2, "0") + i.getDate().toString().padStart(2, "0")), e ? s : a2 ? (s += "T" + i.getHours().toString().padStart(2, "0") + i.getMinutes().toString().padStart(2, "0") + i.getSeconds().toString().padStart(2, "0"), s) : (s += "T" + i.getUTCHours().toString().padStart(2, "0") + i.getUTCMinutes().toString().padStart(2, "0") + i.getUTCSeconds().toString().padStart(2, "0") + (n ? "" : "Z"), s);
  } else if (R(t)) {
    let i = a2 ? k(t) && !t.tz() ? t.clone().tz(a2) : t : n || e && k(t) && t.tz() ? t : t.utc();
    return i.format("YYYYMMDD") + (e ? "" : "T" + i.format("HHmmss") + (n || a2 ? "" : "Z"));
  } else if (S(t)) {
    let i = a2 ? t.setZone(a2) : n || e && t.zone.type !== "system" ? t : t.setZone("utc");
    return i.toFormat("yyyyLLdd") + (e ? "" : "T" + i.toFormat("HHmmss") + (n || a2 ? "" : "Z"));
  } else {
    let i = t;
    if (a2) i = typeof t.tz == "function" ? t.tz(a2) : t;
...
function E(a2, t, e, n) {
  ...
  return (n == null ? void 0 : n.timezone) && (i = ";TZID=" + n.timezone, s = true), t + i + ":" + d(a2, e, false, s);
}
function D(a2) {
...
function G(a2) {
  return typeof a2 == "object" && a2 !== null && !(a2 instanceof Date) && !R(a2) && !S(a2);
}
function S(a2) {
...
function k(a2) {
  return R(a2) && "tz" in a2 && typeof a2.tz == "function";
}
function x(a2) {
  return a2 !== null && typeof a2 == "object" && "between" in a2 && typeof a2.between == "function" && typeof a2.toString == "function";
}
function H(a2) {
  return a2 instanceof Date && "internal" in a2 && a2.internal instanceof Date && "withTimeZone" in a2 && typeof a2.withTimeZone == "function" && "tzComponents" in a2 && typeof a2.tzComponents == "function";
}
function v(a2) {
  return typeof a2 == "string" || a2 instanceof Date ? new Date(a2) : S(a2) ? a2.toJSDate() : a2.toDate();
}
function C(a2) {
  let t = "";
...
var O = ((i) => (i.CHAIR = "CHAIR", i.NON = "NON-PARTICIPANT", i.OPT = "OPT-PARTICIPANT", i.REQ = "REQ-PARTICIPANT", i))(O || {});
var Y = ((n) => (n.CLIENT = "CLIENT", n.NONE = "NONE", n.SERVER = "SERVER", n))(Y || {});
var w = ((s) => (s.ACCEPTED = "ACCEPTED", s.DECLINED = "DECLINED", s.DELEGATED = "DELEGATED", s.NEEDSACTION = "NEEDS-ACTION", s.TENTATIVE = "TENTATIVE", s))(w || {});
var M = ((s) => (s.GROUP = "GROUP", s.INDIVIDUAL = "INDIVIDUAL", s.RESOURCE = "RESOURCE", s.ROOM = "ROOM", s.UNKNOWN = "UNKNOWN", s))(M || {});
var f = class a {
  constructor(t, e) {
    __publicField(this, "data");
    __publicField(this, "parent");
    if (this.data = { delegatedFrom: null, delegatedTo: null, email: "", mailto: null, name: null, role: "REQ-PARTICIPANT", rsvp: null, scheduleAgent: null, sentBy: null, status: null, type: null, x: [] }, this.parent = e, !this.parent) throw new Error("`event` option required!");
  ...
  delegatedFrom(t) {
    return t === void 0 ? this.data.delegatedFrom : (t ? typeof t == "string" ? this.data.delegatedFrom = new a(p("delegatedFrom", t), this.parent) : t instanceof a ? this.data.delegatedFrom = t : this.data.delegatedFrom = new a(t, this.parent) : this.data.delegatedFrom = null, this);
  }
  delegatedTo(t) {
    return t === void 0 ? this.data.delegatedTo : t ? (typeof t == "string" ? this.data.delegatedTo = new a(p("delegatedTo", t), this.parent) : t instanceof a ? this.data.delegatedTo = t : this.data.delegatedTo = new a(t, this.parent), this.data.status = "DELEGATED", this) : (this.data.delegatedTo = null, this.data.status === "DELEGATED" && (this.data.status = null), this);
  }
  delegatesFrom(t) {
  ...
  role(t) {
    return t === void 0 ? this.data.role : (this.data.role = o(O, t), this);
  }
  rsvp(t) {
    return t === void 0 ? this.data.rsvp : t === null ? (this.data.rsvp = null, this) : (this.data.rsvp = !!t, this);
  }
  scheduleAgent(t) {
    return t === void 0 ? this.data.scheduleAgent : t ? typeof t == "string" && t.toUpperCase().startsWith("X-") ? (this.data.scheduleAgent = t, this) : (this.data.scheduleAgent = o(Y, t), this) : (this.data.scheduleAgent = null, this);
  }
  sentBy(t) {
    return t ? (this.data.sentBy = t, this) : this.data.sentBy;
  }
  status(t) {
    return t === void 0 ? this.data.status : t ? (this.data.status = o(w, t), this) : (this.data.status = null, this);
  }
  toJSON() {
    var _a, _b;
...
`, t;
  ...
  type(t) {
    return t === void 0 ? this.data.type : t ? (this.data.type = o(M, t), this) : (this.data.type = null, this);
  }
  x(t, e) {
...
var V = ((n) => (n.audio = "audio", n.display = "display", n.email = "email", n))(V || {});
var j = { end: "END", start: "START" };
var I = class {
  constructor(t, e) {
    __publicField(this, "data");
    __publicField(this, "event");
    if (this.data = { attach: null, attendees: [], description: null, interval: null, relatesTo: null, repeat: null, summary: null, trigger: -600, type: "display", x: [] }, this.event = e, !e) throw new Error("`event` option required!");
  ...
  attach(t) {
    ...
    let e = null;
    if (typeof t == "string") e = { mime: null, uri: t };
    else if (typeof t == "object") e = { mime: t.mime || null, uri: t.uri };
    ...
    return this.data.attach = { mime: e.mime, uri: e.uri }, this;
  }
  attendees(t) {
...
` : typeof this.data.trigger == "number" ? t += "TRIGGER;RELATED=" + ((_a = this.data.relatesTo) == null ? void 0 : _a.toUpperCase()) + ":" + C(this.data.trigger) + `\r
...
var L = ((i) => (i.BUSY = "BUSY", i.FREE = "FREE", i.OOF = "OOF", i.TENTATIVE = "TENTATIVE", i))(L || {});
var z = ((n) => (n.CONFIDENTIAL = "CONFIDENTIAL", n.PRIVATE = "PRIVATE", n.PUBLIC = "PUBLIC", n))(z || {});
var U = ((n) => (n.CANCELLED = "CANCELLED", n.CONFIRMED = "CONFIRMED", n.TENTATIVE = "TENTATIVE", n))(U || {});
var B = ((e) => (e.OPAQUE = "OPAQUE", e.TRANSPARENT = "TRANSPARENT", e))(B || {});
var y = class {
  constructor(t, e) {
  ...
  busystatus(t) {
    return t === void 0 ? this.data.busystatus : t === null ? (this.data.busystatus = null, this) : (this.data.busystatus = o(L, t), this);
  }
  categories(t) {
    return t ? (t.forEach((e) => this.createCategory(e)), this) : this.data.categories;
  }
  class(t) {
    return t === void 0 ? this.data.class : t === null ? (this.data.class = null, this) : (this.data.class = o(z, t), this);
  }
  createAlarm(t) {
  ...
  repeating(t) {
    ...
    if (this.data.repeating = { freq: o(b, t.freq) }, t.count) {
    ...
    if (t.until !== void 0 && (this.data.repeating.until = h(t.until, "repeating.until")), t.byDay) {
      ...
      this.data.repeating.byDay = e.map((n) => o(A, n));
    }
    if (t.byMonth) {
    ...
    if (t.exclude) {
      ...
      this.data.repeating.exclude = e.map((n, i) => h(n, `repeating.exclude[${i}]`));
    }
    return t.startOfWeek && (this.data.repeating.startOfWeek = o(A, t.startOfWeek)), this;
  }
  sequence(t) {
  ...
  status(t) {
    return t === void 0 ? this.data.status : t === null ? (this.data.status = null, this) : (this.data.status = o(U, t), this);
  }
  summary(t) {
...
`, t;
  ...
  transparency(t) {
    return t === void 0 ? this.data.transparency : t ? (this.data.transparency = o(B, t), this) : (this.data.transparency = null, this);
  }
  uid(t) {
  ...
  swapStartAndEndIfRequired() {
    if (this.data.start && this.data.end && v(this.data.start).getTime() > v(this.data.end).getTime()) {
      let t = this.data.start;
      this.data.start = this.data.end, this.data.end = t;
    }
  }
};
var P = ((m) => (m.ADD = "ADD", m.CANCEL = "CANCEL", m.COUNTER = "COUNTER", m.DECLINECOUNTER = "DECLINECOUNTER", m.PUBLISH = "PUBLISH", m.REFRESH = "REFRESH", m.REPLY = "REPLY", m.REQUEST = "REQUEST", m))(P || {});
var T = class {
  constructor(t = {}) {
    __publicField(this, "data");
  ...
  method(t) {
    return t === void 0 ? this.data.method : t ? (this.data.method = o(P, t), this) : (this.data.method = null, this);
  }
  name(t) {
...
`), this.data.events.forEach((e) => t += e.toString()), t += D(this.data), t += "END:VCALENDAR", N(t);
  }
  ttl(t) {
...
export {
  I as ICalAlarm,
  j as ICalAlarmRelatesTo,
  V as ICalAlarmType,
  f as ICalAttendee,
  O as ICalAttendeeRole,
  w as ICalAttendeeStatus,
  M as ICalAttendeeType,
  T as ICalCalendar,
  P as ICalCalendarMethod,
  c as ICalCategory,
  y as ICalEvent,
  L as ICalEventBusyStatus,
  z as ICalEventClass,
  b as ICalEventRepeatingFreq,
  U as ICalEventStatus,
  B as ICalEventTransparency,
  A as ICalWeekday,
  It as default,
  r as escape,
  N as foldLines,
