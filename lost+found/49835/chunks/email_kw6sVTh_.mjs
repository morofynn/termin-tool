...
async function loadEmailSettings(env) {
  try {
    const settingsJson = await env.APPOINTMENTS_KV?.get("app:settings");
    if (settingsJson) {
...
export { sendCustomerNotification as a, sendReminderEmail as b, sendAdminNotification as s, validateFormData as v };
