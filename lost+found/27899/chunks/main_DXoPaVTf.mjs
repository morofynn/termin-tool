...
const $$Main = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"${addAttribute(pageClass, "class")} data-astro-cid-yu3cdcui> <head><meta charset="utf-8"><link rel="icon" type="image/png" href="/favicon.ico"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>Appointment Scheduler</title>${renderHead()}</head> <!-- Dark mode class injection point - will be replaced with \`dark\` class based on your site palette --> <body class="dark" style="background: transparent;" data-astro-cid-yu3cdcui> ${renderSlot($$result, $$slots["default"])} </body></html>`;
