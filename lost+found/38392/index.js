...
import { manifest } from './manifest_BsCDfzSX.mjs';
...
const _page6 = () => import('./pages/api/appointment/cancel.astro.mjs');
const _page7 = () => import('./pages/api/appointment/_id_.astro.mjs');
const _page8 = () => import('./pages/api/availability.astro.mjs');
const _page9 = () => import('./pages/api/book-appointment.astro.mjs');
const _page10 = () => import('./pages/api/debug-slots.astro.mjs');
const _page11 = () => import('./pages/embed.astro.mjs');
const _page12 = () => import('./pages/popup.astro.mjs');
const _page13 = () => import('./pages/secure-admin-panel-xyz789.astro.mjs');
const _page14 = () => import('./pages/termin/_id_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/appointment/cancel.ts", _page6],
    ["src/pages/api/appointment/[id].ts", _page7],
    ["src/pages/api/availability.ts", _page8],
    ["src/pages/api/book-appointment.ts", _page9],
    ["src/pages/api/debug-slots.ts", _page10],
    ["src/pages/embed.astro", _page11],
    ["src/pages/popup.astro", _page12],
    ["src/pages/secure-admin-panel-xyz789.astro", _page13],
    ["src/pages/termin/[id].astro", _page14],
