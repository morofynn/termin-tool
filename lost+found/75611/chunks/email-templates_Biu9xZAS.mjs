...
Termin-Details: ${appointment.appointmentUrl}`
  ...
  calendar.createEvent({
    ...
    summary: settings.eventName ? `Termin: ${settings.companyName} - ${settings.eventName}` : `Termin: ${settings.companyName}`,
    description,
    location: settings.standInfo ? `${settings.standInfo}${settings.eventName ? ` (${settings.eventName})` : ""}` : settings.companyAddress,
...
export { It as I, generateCustomerCancellationEmail as a, generateICS as b, generateCustomerRequestEmail as c, generateAdminNotificationEmail as d, generateCustomerReminderEmail as e, generateCustomerConfirmationEmail as g, validateFormData as v };
